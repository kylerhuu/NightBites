...
struct StudentStickyCartBar: View {
    ...
    var body: some View {
        ...
        .accessibilityLabel("Bag, \(itemCount) items, \(String(format: "$%.2f", subtotal))")
        .accessibilityHint(isActionable ? "Opens checkout" : "Checkout unavailable while this truck is not taking orders")
